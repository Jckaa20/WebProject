...
<body>
	...
	b = dao.getElementById(id);
%>
	<script type="text/javascript" src="validate.js"></script>
	<h4>Update Books</h4>
	<form action="UpdateIssuedBook" method="post" onsubmit="booksValidate">
		<input type="hidden" name="id" value="<%=b.getId() %>" id="id">
		Book Id:<br> <input type="text" name="bid"
			value="<%=b.getBid() %>" id="bid"><br>
		...
		<br> <input type="submit" value="Edit & Save"
			onclick="booksValidate"> <a href="ViewIssuedBook"><input
